  ...
  <AppPage :show-footer="true">
    ...
    <div class="mt-12 flex">
      ...
      <n-card class="ml-12" title="技术栈" segmented>
        <VChart ref="charts" class="wh-full" />
      </n-card>
    </div>

    <n-card class="mt-12" title="趋势" segmented>
      <VChart ref="charts2" class="h-480 w-full" />
    </n-card>
  </AppPage>
</template>
...
const reSizeData = () => {
  ...
  charts2.value && charts2.value.resize()
  setOption(charts, skillsOption)
  setOption(charts2, trendOption)
}
